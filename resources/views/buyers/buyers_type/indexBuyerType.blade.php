                                        ...
                                        <div class="responsive-table">
                                            <table id="users-list-datatable" class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="border-primary" href="{{ route('buyer.type.edit', 1)}}"><i class="material-icons  edit-icon">edit</i></a><a href="{{ route('location.types.show', 1)}}"><i class="material-icons">remove_red_eye</i></a></td>
                                                    {{-- <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td> --}}
