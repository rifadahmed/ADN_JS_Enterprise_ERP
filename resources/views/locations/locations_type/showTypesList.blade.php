            ...
            <div class="col s12">
                <div class="container">
                                        ...
                                        <div class="responsive-table">
                                            <table id="users-list-datatable" class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="border-primary" href="{{ route('location.types.edit', 1)}}"><i class="material-icons  edit-icon">edit</i></a><a href="page-users-view.html"><i class="material-icons">remove_red_eye</i></a></td>
                                                    {{-- <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td> --}}
                    ...
                    <span class="green-text">Active</span>
                                                    ...
                                                    <td><a href="{{ route('location.types.edit', 1)}}"><i class="material-icons  edit-icon">edit</i></a><a href="page-users-view.html"><i class="material-icons">remove_red_eye</i></a></td>
