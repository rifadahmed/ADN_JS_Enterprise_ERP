    ...
    <nav class="navbar-main navbar-color nav-collapsible sideNav-lock no-shadow {{$nav_color}}"> 
            ...
            <div class="nav-wrapper">
                ...
                <ul class="navbar-list right">
                    ...
                    <li style="letter-spacing:2px;"> <i class="material-icons" >add_shopping_cart</i><p style="margin: -70px 450px 0 33px ;">  TOTAL PURCHASES :<span style="color: #F086A3"> BDT 30,000</p></span></li>
