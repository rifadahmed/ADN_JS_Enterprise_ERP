                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('subcategory.list') }}">Manage SubCategory</a>
                                </li>
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <span class="green-text">Active</span>
                                                    ...
                                                    <td><a href="{{ route('subcategory.edit', 1)}}"><i class="material-icons  edit-icon">edit</i></a><a href="{{ route('subcategory.show', 1)}}"><i class="material-icons">remove_red_eye</i></a></td>
